...
/***/ function(module, exports) {
	...
	module.exports = {
	  buttons: [[].concat(_toConsumableArray(document.querySelectorAll(".row1 > button"))), [].concat(_toConsumableArray(document.querySelectorAll(".row2 > button"))), [].concat(_toConsumableArray(document.querySelectorAll(".row3 > button")))],
